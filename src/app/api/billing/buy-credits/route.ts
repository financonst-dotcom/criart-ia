...
const CREDIT_PACKS = {
  pack_100: { credits: 100, price: 1990, label: "100 creditos" },
  pack_300: { credits: 300, price: 4990, label: "300 creditos" },
  pack_700: { credits: 700, price: 9990, label: "700 creditos" },
  pack_1500: { credits: 1500, price: 17990, label: "1500 creditos" },
} as const;
...
export async function POST(req: Request) {
  try {
    ...
    if (!parsed.success) return NextResponse.json({ error: "Pack invalido" }, { status: 400 });
      ...
      line_items: [
        {
          price_data: {
            ...
            product_data: {
              name: pack.label,
              description: `${pack.credits} creditos para usar nas ferramentas de IA`,
            },
          },
          quantity: 1,
        },
